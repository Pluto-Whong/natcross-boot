...
public class NatcrossSpringConstants {
    ...
    public void setSERVER_SEND_URGENT_DATA_INTERVAL_MILLIS(Long sERVER_SEND_URGENT_DATA_INTERVAL_MILLIS) {
        NatcrossConstants.SERVER_SEND_URGENT_DATA_INTERVAL_MILLIS = sERVER_SEND_URGENT_DATA_INTERVAL_MILLIS;
        log.trace("SERVER_SEND_URGENT_DATA_INTERVAL_MILLIS[{}]",
                NatcrossConstants.SERVER_SEND_URGENT_DATA_INTERVAL_MILLIS);
    }
